...
<body>
    ...
    <div class="col-lg-4 col-md-6 col-sm-8 offset-lg-4 offset-md-3 offset-sm-2 divup">
        <br>
                ...
                <p style="margin: 0;  font-size: 25px; color:#5B4E2C ; font-family: Roboto; font-weight: bold; text-align: center;">Forget Password</p>
                ...
                <div class="container text-center">
                    ...
                    <button type="submit" onclick="error()" name="submit_btn" class="btn buttoncst">Reset Password</button>
                    </form>
                    <a href="login.php" style="text-decoration: none; color:#835328;">Login</a>/
