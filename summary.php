...
<div class="col-6 text-center">
        <a href="sales.php" >Order History</a>
    </div>
    <div class="col-6 text-center" style="border-bottom: 2px solid #7F4F24; font-weight:bold;">
    <a href="summary.php" disable><span style="color: #7F4F24;">Sales Summary</span></a>
    </div>
</div>
...
<div class="card card-body">
            ...
            while ($row = $result->fetch_assoc()) { 
                ?>
                <div class="col-3"><?php echo $row['item_code']?></div>
                <div class="col-3"><?php echo $row['item_name']?></div>
                <div class="col-3"><?php echo $row['total_quantity']?></div>
                <div class="col-3">₱ <?php echo $row['total_price']?></div>
                <?php } ?>
            </div>
